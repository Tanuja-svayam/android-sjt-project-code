...
public class GeneralCodeFollowupPurpose_view extends Activity {
    ...
    ListViewAdapter_GeneralCodes_FollowupPurpose adapter;
    private ListView lv;
        ...
        try {
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_GeneralCodes_FollowupPurpose(GeneralCodeFollowupPurpose_view.this, arraylist);
