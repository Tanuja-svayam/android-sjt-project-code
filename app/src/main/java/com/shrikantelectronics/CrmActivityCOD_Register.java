...
public class CrmActivityCOD_Register extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_crmccodcustomerlist);
	...
	public void invokeWS_DailySales() {
		...
		try {
			...
			header_recovery.setText("COD FOLLOWUP");

			ApiHelper.post(URL + "Service1.asmx/CRM_DailyCOD_Employee", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						TableRow tblrowHeading = new TableRow(CrmActivityCOD_Register.this);
						...
						for (int i = 0, count = new_array.length(); i < count; i++) {
							try {
								...
								TableRow tblrowLabels = new TableRow(CrmActivityCOD_Register.this);
								...
								highsLabel_custname.setOnClickListener(new View.OnClickListener()
								{
									...
									{
										Intent intent = new Intent(CrmActivityCOD_Register.this, CrmActivityCOD_Single.class);
						...
						TableRow tblrowFooter = new TableRow(CrmActivityCOD_Register.this);
	...
	private TextView initPlainTextView(float n) {
		...
		TextView textView = new TextView(CrmActivityCOD_Register.this);
