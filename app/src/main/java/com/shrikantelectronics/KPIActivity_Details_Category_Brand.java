...
public class KPIActivity_Details_Category_Brand extends AppCompatActivity {
    ...
    public void invokeWS_MontlySales() {
            ...
            ApiHelper.post(URL + "Service1.asmx/KPI_DetailValues", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(KPIActivity_Details_Category_Brand.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(KPIActivity_Details_Category_Brand.this);
                                final String s;
                               ...
                               final TextView highsLabel_category = initPlainTextView(i);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(KPIActivity_Details_Category_Brand.this, KPIActivity_Details_Brand_Category_Location.class);
                                        intent.putExtra("TYPE","LOCATION");
                                        intent.putExtra("VALUETYPE",ValueType);
                                        intent.putExtra("Brand_ID",s);
                        ...
                        TableRow tblrowFooter = new TableRow(KPIActivity_Details_Category_Brand.this);
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(KPIActivity_Details_Category_Brand.this);
