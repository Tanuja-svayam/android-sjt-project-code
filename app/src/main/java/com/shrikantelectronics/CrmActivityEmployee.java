...
public class CrmActivityEmployee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        invokeWS_FollowupSummary_Pending_Employee();

        invokeWS_FollowupSummary_Completed();
    }

    public void invokeWS_FollowupSummary_Pending_Employee() {
        ...
        try {
            ...
            String groupcode =  globalVariable.getgroupcode();
            ...
            ApiHelper.post(URL + "Service1.asmx/Followup_Summary_Pending_Employee", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivityEmployee.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivityEmployee.this);
                                ...
                                final String employeename = jsonObject.getString("activitytypedesc");
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(CrmActivityEmployee.this, CrmActivityLeadsRegister.class);
                        ...
                        TableRow tblrowFooter = new TableRow(CrmActivityEmployee.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    public void onClick(View v)
                                    {
                                        Intent intent = new Intent(CrmActivityEmployee.this, CrmActivityLeads.class);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(CrmActivityEmployee.this);
