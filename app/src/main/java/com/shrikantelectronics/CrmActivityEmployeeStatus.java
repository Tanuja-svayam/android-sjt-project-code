...
public class CrmActivityEmployeeStatus extends ListActivity {
	// Progress Dialog
	...
	public void invokeWS_Product(Map<String, String> paramsMap) {
		try {
			...
			ApiHelper.post(URL + "Service1.asmx/GenerateActivityEmployeeStatus", paramsMap, new ApiHelper.ApiCallback() {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_CrmActivityStatus(CrmActivityEmployeeStatus.this, arraylist);
