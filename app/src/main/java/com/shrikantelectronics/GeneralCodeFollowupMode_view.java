...
public class GeneralCodeFollowupMode_view extends Activity {
    ...
    ListViewAdapter_GeneralCodes_FollowupMode adapter;
    private ListView lv;
        ...
        try {
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_GeneralCodes_FollowupMode(GeneralCodeFollowupMode_view.this, arraylist);
