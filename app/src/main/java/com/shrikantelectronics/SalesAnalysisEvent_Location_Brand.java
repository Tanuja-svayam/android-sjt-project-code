...
public class SalesAnalysisEvent_Location_Brand extends AppCompatActivity {
   ...
   @Override
    ...
    public void navigatetoStockAnalysis_Category(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Location_Brand.this, SalesAnalysisEvent_Location_Category.class);
    ...
    public void navigatetoStockAnalysis_Brand(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Location_Brand.this,SalesAnalysisEvent_Location_Brand.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("location",location);
        homeIntent.putExtra("eventdescription",eventdescription);
    ...
    public void navigatetoStockAnalysis_Location(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Location_Brand.this,SalesAnalysisEvent_Location.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("eventdescription",eventdescription);
        finish();
    ...
    public void invokeWS_EventSalesAnalysis() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/SalesAnalysis_Event_Location_Brand", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // myLinearLayout.someTableView.removeAllViews();
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisEvent_Location_Brand.this);
                        TextView highsHeading_location = initPlainHeaderTextView();
                        highsHeading_location.setText("Event");
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisEvent_Location_Brand.this);

                                final TextView highsLabel_location = initPlainTextView(i);
                                highsLabel_location.setText(jsonObject.getString("eventdescription"));
                        ...
                        TableRow tblrowFooter = new TableRow(SalesAnalysisEvent_Location_Brand.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesAnalysisEvent_Location_Brand.this);
