...
public class DeliveryReceiptImageActivity extends AppCompatActivity {
  ...
  public String foldername ="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setSupportActionBar(toolbar);
       ...
       // txtUpdatedOn = (TextView) findViewById(R.id.updated_on);
        ...
        if (!CameraUtils_DeliveryReceipt.isDeviceSupportCamera(getApplicationContext())) {
        ...
        btnCapturePicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (CameraUtils_DeliveryReceipt.checkPermissions(getApplicationContext())) {
                    captureImage();
                } else {
    ...
    private void captureImage() {
        ...
        File file = CameraUtils_DeliveryReceipt.getOutputMediaFile(MEDIA_TYPE_IMAGE, filename);
        if (file != null) {
            imageStoragePath = file.getAbsolutePath();
        }

        Uri fileUri = CameraUtils_DeliveryReceipt.getOutputMediaFileUri(getApplicationContext(), file);
    ...
    private void captureVideo() {
        ...
        File file = CameraUtils_DeliveryReceipt.getOutputMediaFile(MEDIA_TYPE_VIDEO, filename);
        if (file != null) {
            imageStoragePath = file.getAbsolutePath();
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CAMERA_CAPTURE_IMAGE_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                CameraUtils_DeliveryReceipt.refreshGallery(getApplicationContext(), imageStoragePath);
    ...
    private void previewCapturedImage() {
        try {
            ...
            Bitmap bitmap = CameraUtils_DeliveryReceipt.optimizeBitmap(BITMAP_SAMPLE_SIZE, imageStoragePath);
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils_DeliveryReceipt.openSettings(DeliveryReceiptImageActivity.this);
                    }
                })
    ...
    private void launchUploadActivity(boolean isImage){
       ...
       // startActivity(i);
        ...
        new DeliveryReceiptImageActivity.UploadFileToServer().execute();
    }
    ...
    public void invokeWS(){
        ...
        paramsMap.put("productimage", "" + filename);

        //STARWING -- SERVER
        //AsyncHttpClient client = new AsyncHttpClient();
        ApiHelper.post(URL + "Service1.asmx/UpdateProductImageInvoiceOrderDetail", paramsMap, new ApiHelper.ApiCallback() {
            @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(DeliveryReceiptImageActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(DeliveryReceiptImageActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
