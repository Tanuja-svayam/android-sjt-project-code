...
public class pendingdelivery_view extends AppCompatActivity {
    ...
    ListViewAdapter_PendingDelivery adapter;
    ...
    public void invokeWS_Product(Map<String, String> paramsMap){
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetDeliveryPendingList", paramsMap, new ApiHelper.ApiCallback()   {
            @Override
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_PendingDelivery(pendingdelivery_view.this, arraylist);
