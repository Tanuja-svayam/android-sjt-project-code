...
public class CrmActivityFollowup_Customer_Single extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crmwalkincustomer_view_single);
    ...
    public void onClick_add_product(View view) {
        Intent homeIntent = new Intent(CrmActivityFollowup_Customer_Single.this,SalesOrdernmodel_view.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

        homeIntent.putExtra("sysinvorderno",sysinvorderno);
        homeIntent.putExtra("custcd",custcd1);
        homeIntent.putExtra("custname",custname1);
        homeIntent.putExtra("refbillno","");
        finish();
            ...
            ApiHelper.post(URL + "Service1.asmx/GetFollowupCustomerDetailsSingle", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    ...
                    try {
                        ...
                        txtoutstanding.setText(jsonObject.getString("priceoffered"));
                        txtaddress.setText(jsonObject.getString("address"));
                        txtinquiredproduct.setText(jsonObject.getString("inquiredproduct"));
                        ...
                        outstanding1 = jsonObject.getString("priceoffered");
                        inquiredproduct = jsonObject.getString("inquiredproduct");
            ...
            public void onSuccess(JSONObject response) {
                ...
                try {
                   ...
                   Toast.makeText(getApplicationContext(), obj.getString("error_msg"), Toast.LENGTH_LONG).show();
                    ...
                    Intent homeIntent = new Intent(CrmActivityFollowup_Customer_Single.this,CrmActivityEmployee.class);
            ...
            ApiHelper.post(URL + "Service1.asmx/CRM_Followup_Details_By_Activity", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivityFollowup_Customer_Single.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivityFollowup_Customer_Single.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(CrmActivityFollowup_Customer_Single.this);
