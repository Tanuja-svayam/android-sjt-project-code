...
public class SalesActivity_Daily_Negetive extends AppCompatActivity {
    ...
    public void navigatetoSalesPerformanceActivity(){
        Intent homeIntent = new Intent(SalesActivity_Daily_Negetive.this,SalesPerformance_view.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeIntent);
    }

    public void navigatetoSalesStatusActivity(){
        Intent homeIntent = new Intent(SalesActivity_Daily_Negetive.this,OutboxActivity.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeIntent);
    }
    ...
    public void invokeWS_DailySales(String locationname, String fromdate) {
        ...
        try {
            ...
            header_salesregister.setText(locationname + " " + fromdate + " DAILY SALES");

            ApiHelper.post(URL + "Service1.asmx/Sales_DailySummary_Negetive", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(SalesActivity_Daily_Negetive.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesActivity_Daily_Negetive.this);
                                ...
                                highsLabel_custname.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesActivity_Daily_Negetive.this, customer_view_single.class);
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(SalesActivity_Daily_Negetive.this);
