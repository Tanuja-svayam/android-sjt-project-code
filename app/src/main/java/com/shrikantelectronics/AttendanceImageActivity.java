...
public class AttendanceImageActivity extends AppCompatActivity {
    ...
    String attnstatus, attntype, fileuri;
  ...
  public String foldername ="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setSupportActionBar(toolbar);
       ...
       // txtUpdatedOn = (TextView) findViewById(R.id.updated_on);
        ...
        attntype = i.getStringExtra("attntype");
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(AttendanceImageActivity.this);
                    }
                })
    ...
    private void launchUploadActivity(boolean isImage){
       // Intent i = new Intent(AttendanceImageActivity.this, UploadActivity.class);
       // i.putExtra("filePath",imageStoragePath);
       // i.putExtra("isImage", isImage);
       // startActivity(i);

        new AttendanceImageActivity.UploadFileToServer().execute();
    }
    ...
    private class UploadFileToServer extends AsyncTask<Void, Void, String> {
        ...
        private String uploadFile() {
            ...
            String ATTENDANCE_FILE_UPLOAD_URL =
                     //"http://" + Utility.IPAddress + ":4033/ShrikantElectronics/EmployeeAttendance/fileUpload.php";
                      "http://" + Utility.IPAddress + ":4033/SJT/EmployeeAttendance/fileUpload.php";
        ...
        protected void onPostExecute(String result) {
            ...
            showAlert(result);   // your method to show server response
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(AttendanceImageActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(AttendanceImageActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
