...
public class Service_Call_Service_Center_Summary extends AppCompatActivity {
   ...
   @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_center_summary);
       ...
       invokeWS_Service_Service_Center_Summary();

    }

    public void invokeWS_Service_Service_Center_Summary() {
        ...
        try {
            ...
            paramsMap.put("servicecentercd", "0");

            final int DEFAULT_TIMEOUT = 200000 * 1000000000;
            //AsyncHttpClient client = new AsyncHttpClient();
            //client.setTimeout(DEFAULT_TIMEOUT);

            ApiHelper.post(URL + "Service1.asmx/Service_Call_Service_Center_Summary", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // tabletoplocationstock.setShrinkAllColumns(true);
                        ...
                        TableRow tblrowHeading = new TableRow(Service_Call_Service_Center_Summary.this);
                        ...
                        JSONArray new_array = obj.getJSONArray("Calls_Service_Center_StatusWise");

                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                JSONObject jsonObject = new_array.getJSONObject(i);

                                TableRow tblrowLabels = new TableRow(Service_Call_Service_Center_Summary.this);

                                final String servicecentercd =  jsonObject.getString("servicecentercd");
                                final String servicecentername =  jsonObject.getString("servicecentername");

                                final TextView highsLabel_Center = initPlainTextView(i);
                                highsLabel_Center.setText(jsonObject.getString("servicecentername"));
                                ...
                                tblrowLabels.setOnClickListener(new OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(Service_Call_Service_Center_Summary.this, Service_Call_Status_Summary.class);
                                        intent.putExtra("servicecentercd",servicecentercd);
                                        intent.putExtra("servicecentername",servicecentername);
                        ...
                        TableRow tblrowFooter = new TableRow(Service_Call_Service_Center_Summary.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(Service_Call_Service_Center_Summary.this);
