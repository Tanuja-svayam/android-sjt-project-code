...
public class SalesActivity extends AppCompatActivity {
    ...
    public void invokeWS_MontlySales() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/Sales_MonthSummary", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(SalesActivity.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesActivity.this);
                               ...
                               final TextView highsLabel_category = initPlainTextView(i);
                                ...
                                tblrowLabels.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesActivity.this, SalesActivity_Daily.class);
                        ...
                        TableRow tblrowFooter = new TableRow(SalesActivity.this);
    ...
    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(SalesActivity.this);
