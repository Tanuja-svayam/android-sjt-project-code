...
public class StockVerificationCustomerPriority_view extends Activity {
    ...
    ListViewAdapter_GeneralCodes_CustomerPriority adapter;
    private ListView lv;
        ...
        try {
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_GeneralCodes_CustomerPriority(StockVerificationCustomerPriority_view.this, arraylist);
