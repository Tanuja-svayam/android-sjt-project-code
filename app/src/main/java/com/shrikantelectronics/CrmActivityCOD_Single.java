...
public class CrmActivityCOD_Single extends AppCompatActivity {
...
String mobile, emailid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crmcodcustomer_view_single);
    ...
    public void invokeWS_Customer_Details(){
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetFollowupCustomerDetailsSingle_COD", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
    ...
    public void invokeUpdateFollowupWS(Map<String, String> paramsMap){
        ...
        ApiHelper.post(URL + "Service1.asmx/UpdateCODFolloupStatus", paramsMap, new ApiHelper.ApiCallback() {
            ...
            public void onSuccess(JSONObject response) {
                ...
                try {
                    ...
                    if(obj.getBoolean("status")){
                        ...
                        Intent intent = new Intent(getApplicationContext(), CrmActivityCOD_Register.class);
    ...
    public void invokeWS_Followup_History(String sysreceiptno) {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/CRM_COD_Followup_Details", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivityCOD_Single.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivityCOD_Single.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(CrmActivityCOD_Single.this);
