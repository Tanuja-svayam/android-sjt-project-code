...
public class SalesOrderReceipt_Outstanding_Activity extends AppCompatActivity {
    ...
    EditText paymodenameET, voucherrefnoET, amountET, referenceperson_name_recET, referenceperson_mobile_recET;
    TextView voucherdtET, duedateET;

    int year, month, day;

    Button Button_paymodename, btnCreateCashReceipt;
    String syspaymodeno, companycd, sysinvorderno, sysreceiptno,dbdoncustomer, referenceperson_name_rec, referenceperson_mobile_rec, duedate;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_salesorderreceipt_outstanding);
        ...
        referenceperson_name_recET = (EditText)findViewById(R.id.referenceperson_name_rec);
        referenceperson_mobile_recET = (EditText)findViewById(R.id.referenceperson_mobile_rec);
        duedateET = (TextView)findViewById(R.id.duedate);

        Intent i = getIntent();
        if( i.getStringExtra("sysinvorderno") != null)
        {
                sysinvorderno = i.getStringExtra("sysinvorderno");
            Invoke_SalesOrderDetails_Outstanding(sysreceiptno, sysinvorderno);
        ...
        duedateET.setText(Utility.ConvetToDDMMMYYYY(year,month,day));
    ...
    public void Invoke_SalesOrderDetails_Outstanding(String dsysreceiptno, String dsysinvorderno) {
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetSalesmen_SalesOrderDetails_Outstanding", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                public void onSuccess(JSONObject response) {
                    ...
                    try {
                        ...
                        referenceperson_name_recET.setText(jsonObject.getString("referenceperson_name_rec"));
                        referenceperson_mobile_recET.setText(jsonObject.getString("referenceperson_mobile_rec"));
                        duedateET.setText(jsonObject.getString("vduedate"));
    ...
    public void navigatetopaymodenameListActivity(){
        Intent homeIntent = new Intent(SalesOrderReceipt_Outstanding_Activity.this,StockVerificationPaymentMode_view.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivityForResult(homeIntent,5);
    }

    public void Submit_CreateOutstanding(){
        ...
        String referenceperson_name_rec = referenceperson_name_recET.getText().toString();
        String referenceperson_mobile_rec = referenceperson_mobile_recET.getText().toString();
        ...
        if (Utility.isNotNull(sysinvorderno) && Utility.isNotNull(syspaymodeno) ) {
            ...
            if (Utility.isNotNull(paymodename)) {
                ...
                paramsMap.put("referenceperson_name_rec", ""+referenceperson_name_rec);
                paramsMap.put("referenceperson_mobile_rec", ""+referenceperson_mobile_rec);
                paramsMap.put("duedate", ""+duedate);
    ...
    public void invokeWS(Map<String, String> paramsMap){
        ...
        ApiHelper.post(URL + "Service1.asmx/SalesOrderReceipt_Add_Outstanding", paramsMap, new ApiHelper.ApiCallback() {
                ...
                try {
                    ...
                    for (int i = 0, count = new_array.length(); i < count; i++) {
                        try {
                            ...
                            Toast.makeText(getApplicationContext(), "Outstanding Added Successfully", Toast.LENGTH_LONG).show();
    ...
    public void setDefaultValues(){
        ...
        amountET.setText("");
        voucherdtET.setText("");
        referenceperson_name_recET.setText("");
        referenceperson_mobile_recET.setText("");
        duedateET.setText("");
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        if (id == 997) {
            return new DatePickerDialog(this,
                    VoucherDateListener, year, month, day);
        }
    ...
    private DatePickerDialog.OnDateSetListener VoucherDateListener = new
            DatePickerDialog.OnDateSetListener() {
                @Override
                public void onDateSet(DatePicker arg0,
                                      int arg1, int arg2, int arg3) {

                    showVoucherDate(arg1, arg2, arg3);
                }
            };

    private void showVoucherDate(int year, int month, int day) {
        voucherdtET = (TextView) findViewById(R.id.voucherdt);
        voucherdtET.setText(Utility.ConvetToDDMMMYYYY(year,month,day));
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesOrderReceipt_Outstanding_Activity.this);
