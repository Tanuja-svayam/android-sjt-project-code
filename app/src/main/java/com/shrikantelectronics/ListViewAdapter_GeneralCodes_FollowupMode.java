...
public class ListViewAdapter_GeneralCodes_FollowupMode extends BaseAdapter {
    ...
    public ListViewAdapter_GeneralCodes_FollowupMode(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("gcname",(GeneralCodeslist.get(position).getgcname()));
                ...
                ((GeneralCodeFollowupMode_view)mContext).setResult(GeneralCodeFollowupMode_view.RESULT_OK,intent);
                ((GeneralCodeFollowupMode_view)mContext).finish();
