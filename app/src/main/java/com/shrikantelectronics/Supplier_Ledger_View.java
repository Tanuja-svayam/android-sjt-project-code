...
public class Supplier_Ledger_View extends AppCompatActivity {

    private static String URL = Config.WEBSERVICE_URL;
    private static String IMAGEURL = Config.IMAGEURL_URL;

    ListViewAdapter_Supplier_Ledger adapter;
    ...
    ArrayList<Supplier_Ledger> arraylist = new ArrayList<Supplier_Ledger>();
    ...
    TextView header_suppliername;
    TableLayout tablesalesregister;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_supplier_ledger_view);
        ...
        header_suppliername = (TextView) findViewById(R.id.header_suppliername);
        header_suppliername.setText(name);
        ...
        invokeWS_Supplier_Ledger(sysvendorno);
    }

    public void invokeWS_Supplier_Ledger(String sysvendorno){
        try {
            ...
            paramsMap.put("dsysvendorno", sysvendorno);
            paramsMap.put("fromdate", pickFromDate.getText().toString());
            paramsMap.put("todate", pickToDate.getText().toString());

            //AsyncHttpClient client1 = new AsyncHttpClient();
            ApiHelper.post(URL + "Service1.asmx/GetSupplierLedger", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                public void onSuccess(JSONObject response) {

                    try {

                        tablesalesregister  = (TableLayout) findViewById(R.id.tablesupplierledger);
                        tablesalesregister.removeAllViews();

                        tablesalesregister.setStretchAllColumns(true);
                        //tablesalesregister.setShrinkAllColumns(true);

                        TableRow tblrowHeading = new TableRow(Supplier_Ledger_View.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(Supplier_Ledger_View.this);
                        ...
                        TableRow tblrowFooter = new TableRow(Supplier_Ledger_View.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(Supplier_Ledger_View.this);
