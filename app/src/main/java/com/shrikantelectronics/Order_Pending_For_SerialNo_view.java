...
public class Order_Pending_For_SerialNo_view extends AppCompatActivity {
   ...
   // int[] invoiceimage;
    ...
    public void invokeWS_Product(Map<String, String> paramsMap){
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetSalesmen_SalesOrderDetails_Pending_Serial", paramsMap, new ApiHelper.ApiCallback()   {
            @Override
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_Order(Order_Pending_For_SerialNo_view.this, arraylist);
