...
public class Ledger_CreditCard_View extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        systidno = i.getStringExtra("systidno");
        ...
        invokeWS_CreditCard_Ledger(systidno);
    }

    public void invokeWS_CreditCard_Ledger(String systidno){
        try {
            ...
            paramsMap.put("dsystidno", systidno);
            paramsMap.put("fromdate", pickFromDate.getText().toString());
            paramsMap.put("todate", pickToDate.getText().toString());

            //AsyncHttpClient client1 = new AsyncHttpClient();
            ApiHelper.post(URL + "Service1.asmx/GetCreditCardLedger", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                public void onSuccess(JSONObject response) {
                    ...
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(Ledger_CreditCard_View.this);
                        ...
                        JSONArray new_array = obj.getJSONArray("creditcardledger");
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(Ledger_CreditCard_View.this);
                        ...
                        TableRow tblrowFooter = new TableRow(Ledger_CreditCard_View.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(Ledger_CreditCard_View.this);
