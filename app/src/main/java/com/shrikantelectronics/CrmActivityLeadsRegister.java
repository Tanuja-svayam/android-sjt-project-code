...
public class CrmActivityLeadsRegister extends AppCompatActivity {
	...
	public void invokeWS_DailySales() {
		...
		try {
			...
			header_salesregister.setText("WALKIN REGISTER");

			ApiHelper.post(URL + "Service1.asmx/CRM_DailyLeads_Register", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						TableRow tblrowHeading = new TableRow(CrmActivityLeadsRegister.this);
						...
						for (int i = 0, count = new_array.length(); i < count; i++) {
							try {
								...
								TableRow tblrowLabels = new TableRow(CrmActivityLeadsRegister.this);
								...
								highsLabel_custname.setOnClickListener(new View.OnClickListener()
								{
									...
									{
										Intent intent = new Intent(CrmActivityLeadsRegister.this, CreateCustomer_Edit.class);
...
*/
                                ...
                                highsLabel_custname.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    public void onClick(View v)
                                    {
                                        Intent intent = new Intent(CrmActivityLeadsRegister.this, Salesmen_Followup_Customer_Single.class);
	...
	private TextView initPlainTextView(float n) {
		...
		TextView textView = new TextView(CrmActivityLeadsRegister.this);
