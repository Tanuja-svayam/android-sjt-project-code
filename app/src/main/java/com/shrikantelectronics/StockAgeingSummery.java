...
public class StockAgeingSummery extends ListActivity {
	// Progress Dialog
 ...
 //       new LoadInbox().execute();
	...
	public void invokeWS_Product(Map<String, String> paramsMap){
		try {
			...
			ApiHelper.post(URL + "Service1.asmx/GetBranchStockDetails", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_Dashboard_Stock(StockAgeingSummery.this, arraylist);
