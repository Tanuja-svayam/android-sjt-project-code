...
public class DBQueries {
    ...
    public static final String CREATE_EVENT_TABLE =
            "CREATE TABLE " + DBTables.EVENT_TABLE_NAME + " ("
                    + DBTables.EVENT_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                    ...
                    + DBTables.EVENT_EMPLOYEE_ID + " INTEGER,"
                    + DBTables.EVENT_SOURCETABLEPK + " INTEGER,"
                    + DBTables.EVENT_SOURCETABLE + " TEXT"
                    + " )";
