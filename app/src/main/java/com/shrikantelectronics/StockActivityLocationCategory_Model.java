...
public class StockActivityLocationCategory_Model extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.btnExportToPdf) {
            ...
            Utility.exportScrollViewContentToPdf(StockActivityLocationCategory_Model.this,activityLayout);
        }
        ...
        if (id == R.id.btnExportToExcel) {
            ...
            try {
                ...
                Utility.ExportTableLayoutContentToExcel(StockActivityLocationCategory_Model.this,activityLayout);
    ...
    public void navigatetoModelListActivity(){
        Intent homeIntent = new Intent(StockActivityLocationCategory_Model.this,model_view.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeIntent);
    }

    public void navigatetoStockAgeingSummery(){
        Intent homeIntent = new Intent(StockActivityLocationCategory_Model.this,StockActivityAgeingLocationBrand.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(homeIntent);
    }
    ...
    public void navigatetoStockActvitySummery_Category(){
        Intent customerIntent = new Intent(StockActivityLocationCategory_Model.this,StockActivityCategory.class);
    ...
    public void navigatetoStockActvitySummery_Brand(){
        Intent customerIntent = new Intent(StockActivityLocationCategory_Model.this,StockActivityLocationCategory_Model.class);
    ...
    public void navigatetoLocationStockSummery(){
        Intent customerIntent = new Intent(StockActivityLocationCategory_Model.this,StockActivityLocationCategory.class);
        customerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(customerIntent);
    }
    ...
    public void navigatetoLocationStockSummery_Daily(){
        Intent customerIntent = new Intent(StockActivityLocationCategory_Model.this,LocationStockSummery_Daily_List.class);
        customerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(customerIntent);
    }

    public void navigatetoPlanogram(){
        Intent customerIntent = new Intent(StockActivityLocationCategory_Model.this,company_view.class);
        customerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(customerIntent);
    }
            ...
            ApiHelper.post(URL + "Service1.asmx/Stock_LocationStock_Category_Model", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                      ...
                      TableRow tblrowHeading = new TableRow(StockActivityLocationCategory_Model.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(StockActivityLocationCategory_Model.this);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(StockActivityLocationCategory_Model.this, model_view_single.class);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(StockActivityLocationCategory_Model.this);
