...
public class KPIActivity_Details_Category extends AppCompatActivity {
    ...
    public void navigatetoKPIDetailActivity_Brand(){
        Intent customerIntent = new Intent(KPIActivity_Details_Category.this,KPIActivity_Details_Brand.class);
    ...
    public void navigatetoKPIDetailActivity_Category(){
        Intent customerIntent = new Intent(KPIActivity_Details_Category.this,KPIActivity_Details_Category.class);
        customerIntent.putExtra("VALUETYPE",ValueType);
        customerIntent.putExtra("ID","");
        customerIntent.putExtra("ReportName",ReportName);
        customerIntent.putExtra("YearType",YearType);
    ...
    public void navigatetoKPIDetailActivity_Location(){
        Intent customerIntent = new Intent(KPIActivity_Details_Category.this,KPIActivity_Details_Location.class);
        customerIntent.putExtra("VALUETYPE",ValueType);
        customerIntent.putExtra("ID","");
        customerIntent.putExtra("ReportName",ReportName);
        customerIntent.putExtra("YearType",YearType);
    ...
    public void invokeWS_MontlySales() {
            ...
            ApiHelper.post(URL + "Service1.asmx/KPI_DetailValues", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(KPIActivity_Details_Category.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(KPIActivity_Details_Category.this);
                               ...
                               final TextView highsLabel_category = initPlainTextView(i);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(KPIActivity_Details_Category.this, KPIActivity_Details_Category_Brand.class);
                        ...
                        TableRow tblrowFooter = new TableRow(KPIActivity_Details_Category.this);
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(KPIActivity_Details_Category.this);
