...
public class SalesAnalysisEvent_Category_Brand extends AppCompatActivity {
   ...
   @Override
    ...
    public void invokeWS_EventSalesAnalysis() {
        ...
        try {
            ...
            header_toplocationstock.setText(eventdescription + " " + category + " SALES SUMMARY");
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // myLinearLayout.someTableView.removeAllViews();
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisEvent_Category_Brand.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisEvent_Category_Brand.this);
                        ...
                        TableRow tblrowFooter = new TableRow(SalesAnalysisEvent_Category_Brand.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesAnalysisEvent_Category_Brand.this);
