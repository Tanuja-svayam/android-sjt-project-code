...
public class KPIActivity_Details_Location extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kpi_location);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.main_kpiactivitydetails, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_brandwise) {
            navigatetoKPIDetailActivity_Brand();
        } else if (id == R.id.action_categorywise) {
            navigatetoKPIDetailActivity_Category();
        } else if (id == R.id.action_locationwise) {
            navigatetoKPIDetailActivity_Location();
        }
        return super.onOptionsItemSelected(item);
    }

    public void navigatetoKPIDetailActivity_Brand() {
        Intent customerIntent = new Intent(KPIActivity_Details_Location.this, KPIActivity_Details_Brand.class);
        customerIntent.putExtra("VALUETYPE", ValueType);
        customerIntent.putExtra("ID", "");
        customerIntent.putExtra("ReportName", ReportName);
        customerIntent.putExtra("YearType", YearType);
        customerIntent.putExtra("location","");
        customerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        startActivity(customerIntent);
    }

    public void navigatetoKPIDetailActivity_Category() {
        Intent customerIntent = new Intent(KPIActivity_Details_Location.this, KPIActivity_Details_Category.class);
        customerIntent.putExtra("VALUETYPE", ValueType);
        customerIntent.putExtra("ID", "");
        customerIntent.putExtra("ReportName", ReportName);
        customerIntent.putExtra("YearType", YearType);
    ...
    public void navigatetoKPIDetailActivity_Location() {
        Intent customerIntent = new Intent(KPIActivity_Details_Location.this, KPIActivity_Details_Location.class);
        customerIntent.putExtra("VALUETYPE", ValueType);
        customerIntent.putExtra("ID", "");
        customerIntent.putExtra("ReportName", ReportName);
        customerIntent.putExtra("YearType", YearType);
    ...
    public void invokeWS_MontlySales() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/KPI_DetailValues", paramsMap, new ApiHelper.ApiCallback() {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(KPIActivity_Details_Location.this);
                        ...
                        radio_brand = (RadioButton) findViewById(R.id.radio_brand);
                        radio_category = (RadioButton) findViewById(R.id.radio_category);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(KPIActivity_Details_Location.this);

                                final String s;
                                s = jsonObject.getString("ID");

                                final String slocation;
                                slocation=jsonObject.getString("location");
                                ...
                                if (radio_brand.isChecked()) {
                                    tblrowLabels.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            customerIntent.putExtra("ReportName",ReportName);
                                            customerIntent.putExtra("YearType",YearType);
                                            customerIntent.putExtra("location",slocation);
                                            customerIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                            startActivity(customerIntent);
                        ...
                        TableRow tblrowFooter = new TableRow(KPIActivity_Details_Location.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(KPIActivity_Details_Location.this);
