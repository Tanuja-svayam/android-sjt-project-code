...
public class SalesSummery_Category extends ListActivity {
	// Progress Dialog
	...
	public void invokeWS_Product(Map<String, String> paramsMap){
		try {
			...
			ApiHelper.post(URL + "Service1.asmx/GetBranchSalesDetails_Category", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_Dashboard_Sales(SalesSummery_Category.this, arraylist);
