...
public class LocationStockSummery_List extends ListActivity {
	// Progress Dialog
 ...
 //       new LoadInbox().execute();
	...
	public void invokeWS_Product(Map<String, String> paramsMap){
		try {
			...
			ApiHelper.post(URL + "Service1.asmx/GetStock_Summery_Location_Monthly", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_Location_Stock(LocationStockSummery_List.this, arraylist);
