...
public class CrmActivity_Daily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        followupstatus= i.getStringExtra("followupstatus");
    ...
    public void invokeWS_Followuplist(String locationname, String activitytypedesc) {
        ...
        try {
            ...
            paramsMap.put("followupstatus", followupstatus);
            ...
            ApiHelper.post(URL + "Service1.asmx/CRM_Activity_Followup_Daily", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivity_Daily.this);
                        ...
                        highsheading_productvalue.setText("Product Value");
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivity_Daily.this);
                                ...
                                highsLabel_custname.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(CrmActivity_Daily.this, CrmActivityFollowup_Single.class);
                                        intent.putExtra("sysfollowupno",sysfollowupno);
                                ...
                                highslabel_productvalue.setText(jsonObject.getString("productvalue"));
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(CrmActivity_Daily.this);
