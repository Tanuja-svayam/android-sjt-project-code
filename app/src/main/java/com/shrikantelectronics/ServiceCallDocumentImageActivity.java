...
public class ServiceCallDocumentImageActivity extends AppCompatActivity {
    ...
    String syscustactno, activitystatus, fileuri = "";
  ...
  //  TextView txtUpdatedOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_servicecalldocumentimageactivity);
     ...
     //   setSupportActionBar(toolbar);
       ...
       // txtUpdatedOn = (TextView) findViewById(R.id.updated_on);
        ...
        folupconversation= i.getStringExtra("folupconversation");
        nextfollowupdate= i.getStringExtra("nextfollowupdate");
        nextfollowuptime= i.getStringExtra("nextfollowuptime");
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(ServiceCallDocumentImageActivity.this);
                    }
                })
    ...
    private class UploadFileToServer extends AsyncTask<Void, Integer, String> {
        ...
        protected void onProgressUpdate(Integer... progress) {
            ...
            // txtPercentage.setText(progress[0] + "%"); // optional
        }
        ...
        private String uploadFile() {
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url(Config.SERVICE_IMAGE_UPLOAD_URL)
                        .post(requestBody)
                        .build();
    ...
    public void invokeWS(){
        ...
        paramsMap.put("activitystatus", "" + activitystatus);
        ...
        paramsMap.put("nextfollowupdate", "" + nextfollowupdate);
        ...
        ApiHelper.post(URL + "Service1.asmx/AddServiceCallDocument", paramsMap, new ApiHelper.ApiCallback() {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(ServiceCallDocumentImageActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(ServiceCallDocumentImageActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
