...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private int createEvent(SQLiteDatabase sqLiteDatabase, Event event) {
        ...
        contentValues.put(DBTables.EVENT_SOURCETABLE, event.getSourceTable());
        contentValues.put(DBTables.EVENT_SOURCETABLEPK, event.getSourceTablePk());
    ...
    // Read functions
    public Boolean readEventsByServerStatus(SQLiteDatabase sqLiteDatabase, String sourcetable, String sourcetablepk) {
        String[] projection = {
                DBTables.EVENT_ID,DBTables.EVENT_SOURCETABLE,DBTables.EVENT_SOURCETABLEPK};
        String where = DBTables.EVENT_SOURCETABLE + "=? and " + DBTables.EVENT_SOURCETABLEPK + "=?";
        String[] whereArgs = {sourcetable, sourcetablepk};
        Cursor cursor = null;

        cursor = sqLiteDatabase.query(DBTables.EVENT_TABLE_NAME, projection, where, whereArgs, null, null, null);
    ...
    public void addNewEvent(String courseName,
