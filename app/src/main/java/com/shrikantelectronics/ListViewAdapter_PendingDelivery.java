...
public class ListViewAdapter_PendingDelivery extends BaseAdapter {
    ...
    public ListViewAdapter_PendingDelivery(Context context,
       ...
       holder.sysorderdtlno.setText(PendingDeliverylist.get(position).getsysorderdtlno());
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, deliveryreceipt.class);
                ...
                intent.putExtra("companycd",
                        (PendingDeliverylist.get(position).getcompanycd()));

                // Pass all data dp
               // mContext.startActivity(intent);

                Intent intent1 = new Intent(mContext, deliveryreceipt.class);
                ((pendingdelivery_view) mContext).startActivityForResult(intent, 1);
