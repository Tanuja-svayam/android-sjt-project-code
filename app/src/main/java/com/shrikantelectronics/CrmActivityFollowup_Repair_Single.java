...
public class CrmActivityFollowup_Repair_Single extends AppCompatActivity {
    ...
    public void onClick_add_product(View view) {
        Intent homeIntent = new Intent(CrmActivityFollowup_Repair_Single.this,SalesOrdernmodel_view.class);
            ...
            public void onSuccess(JSONObject response) {
                ...
                try {
                   ...
                   Toast.makeText(getApplicationContext(), obj.getString("error_msg"), Toast.LENGTH_LONG).show();
                    ...
                    Intent homeIntent = new Intent(CrmActivityFollowup_Repair_Single.this,CrmActivityComplaints.class);
            ...
            ApiHelper.post(URL + "Service1.asmx/CRM_Followup_Details_By_Activity", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivityFollowup_Repair_Single.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivityFollowup_Repair_Single.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(CrmActivityFollowup_Repair_Single.this);
