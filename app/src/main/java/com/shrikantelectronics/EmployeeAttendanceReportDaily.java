...
public class EmployeeAttendanceReportDaily extends AppCompatActivity {
    ...
    String sysemployeeno, employeename, fromdate,todate ;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_employeeattdailyreport);
        ...
        invokeWS_DailyAttendanceAllEmployee();

    }

    public void invokeWS_DailyAttendanceAllEmployee() {
        ...
        try {
            ...
            header_salesregister.setText(employeename+ " ATTENDANCE");

            ApiHelper.post(URL + "Service1.asmx/Attendance_DailySummary", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(EmployeeAttendanceReportDaily.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(EmployeeAttendanceReportDaily.this);

                                final String sysattnno;

                                sysattnno = jsonObject.getString("sysattnno");
                                ...
                                highsLabel_NAME.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(EmployeeAttendanceReportDaily.this, EmployeeAttendanceDetailSingle.class);
                                        intent.putExtra("sysattnno",sysattnno);
                                        intent.putExtra("attnstatus","01");
                                ...
                                highsLabel_PRESENT.setOnClickListener(new View.OnClickListener()
                                {
                                    @Override
                                    public void onClick(View v)
                                    {
                                ...
                                highslabel_HALF_DAY.setOnClickListener(new View.OnClickListener()
                                {
                                    @Override
                                    public void onClick(View v)
                                    {
                                ...
                                highslabel_LEAVE.setOnClickListener(new View.OnClickListener()
                                {
                                    @Override
                                    public void onClick(View v)
                                    {
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(EmployeeAttendanceReportDaily.this);
