...
public class ListViewAdapter_StockVerification_TopCategory extends BaseAdapter {
    ...
    public ListViewAdapter_StockVerification_TopCategory(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("description",(ProductCategorylist.get(position).getdescription()));
                ...
                ((StockVerificationTopCategory_view)mContext).setResult(StockVerificationTopCategory_view.RESULT_OK,intent);
                ((StockVerificationTopCategory_view)mContext).finish();
