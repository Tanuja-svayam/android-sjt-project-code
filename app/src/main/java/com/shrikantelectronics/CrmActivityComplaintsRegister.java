...
public class CrmActivityComplaintsRegister extends AppCompatActivity {
	...
	public void invokeWS_DailySales() {
		...
		try {
			...
			header_salesregister.setText("COMPLAINTS REGISTER");

			ApiHelper.post(URL + "Service1.asmx/CRM_DailyComplaints_Register", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						TableRow tblrowHeading = new TableRow(CrmActivityComplaintsRegister.this);
						...
						for (int i = 0, count = new_array.length(); i < count; i++) {
							try {
								...
								TableRow tblrowLabels = new TableRow(CrmActivityComplaintsRegister.this);
								...
								highsLabel_custname.setOnClickListener(new View.OnClickListener()
								{
									...
									{
										Intent intent = new Intent(CrmActivityComplaintsRegister.this, CrmActivityFollowup_Complaint_Single.class);
	...
	private TextView initPlainTextView(float n) {
		...
		TextView textView = new TextView(CrmActivityComplaintsRegister.this);
