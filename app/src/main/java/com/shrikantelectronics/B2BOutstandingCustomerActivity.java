...
public class B2BOutstandingCustomerActivity extends AppCompatActivity {
...
String custcd;
    ...
    public void invokeWS_LocationOs() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/Mobile_CustomerAgeingInvoice_B2B", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        header_salesregister.setText("Outstanding Invoice Ageing");
                        ...
                        TableRow tblrowHeading = new TableRow(B2BOutstandingCustomerActivity.this);

                        TextView highsHeading_row_id = initPlainHeaderTextView();
                        highsHeading_row_id.setText("Invoice No");
                        highsHeading_row_id.setTypeface(Typeface.DEFAULT_BOLD);
                        highsHeading_row_id.setGravity(Gravity.CENTER);

                        TextView highsHeading_invoice_no = initPlainHeaderTextView();
                        highsHeading_invoice_no.setText("Invoice No");
                        highsHeading_invoice_no.setTypeface(Typeface.DEFAULT_BOLD);
                        highsHeading_invoice_no.setGravity(Gravity.CENTER);

                        TextView highsHeading_invoice_date = initPlainHeaderTextView();
                        highsHeading_invoice_date.setText("Date");
                        highsHeading_invoice_date.setTypeface(Typeface.DEFAULT_BOLD);
                        highsHeading_invoice_date.setGravity(Gravity.CENTER);
                        ...
                        tblrowHeading.addView(highsHeading_row_id);
                        tblrowHeading.addView(highsHeading_invoice_no);
                        tblrowHeading.addView(highsHeading_invoice_date);
                        ...
                        JSONArray new_array = obj.getJSONArray("customer_ageing_invoice_b2b");

                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                JSONObject jsonObject = new_array.getJSONObject(i);

                                TableRow tblrowLabels = new TableRow(B2BOutstandingCustomerActivity.this);

                                final String sysinvno;
                                sysinvno = jsonObject.getString("sysinvno");


                                TextView highslabel_row_id = initPlainTextView(i);
                                highslabel_row_id.setText(jsonObject.getString("Row_id"));
                                highslabel_row_id.setTypeface(Typeface.DEFAULT);
                                highslabel_row_id.setGravity(Gravity.CENTER);

                                final TextView highsLabel_invoice_no = initPlainTextView(i);
                                highsLabel_invoice_no.setText(jsonObject.getString("refdocumentno"));
                                highsLabel_invoice_no.setTypeface(Typeface.DEFAULT);
                                highsLabel_invoice_no.setGravity(Gravity.LEFT);
                                highsLabel_invoice_no.setOnClickListener(new View.OnClickListener()
                                {
                                    @Override
                                    public void onClick(View v)
                                    {
                                        Intent intent = new Intent(B2BOutstandingCustomerActivity.this, Invoice_view_single.class);
                                ...
                                TextView highsLabel_invoice_date = initPlainTextView(i);
                                highsLabel_invoice_date.setText(jsonObject.getString("vinvoicedt"));
                                highsLabel_invoice_date.setTypeface(Typeface.DEFAULT);
                                highsLabel_invoice_date.setGravity(Gravity.CENTER);
                                ...
                                tblrowLabels.addView(highslabel_row_id);
                                tblrowLabels.addView(highsLabel_invoice_no);
                                tblrowLabels.addView(highsLabel_invoice_date);
                        ...
                        TableRow tblrowFooter = new TableRow(B2BOutstandingCustomerActivity.this);



                        TextView highsFooter_row_id  = initPlainFooterTextView();
                        highsFooter_row_id.setText("");
                        highsFooter_row_id.setTypeface(Typeface.DEFAULT_BOLD);
                        highsFooter_row_id.setGravity(Gravity.CENTER);

                        TextView highsFooter_invoice_no = initPlainFooterTextView();
                        highsFooter_invoice_no.setText("");
                        highsFooter_invoice_no.setTypeface(Typeface.DEFAULT_BOLD);
                        highsFooter_invoice_no.setGravity(Gravity.LEFT);

                        TextView highsFooter_invoice_date = initPlainFooterTextView();
                        highsFooter_invoice_date.setText("Total");
                        highsFooter_invoice_date.setTypeface(Typeface.DEFAULT_BOLD);
                        highsFooter_invoice_date.setGravity(Gravity.LEFT);
                        ...
                        tblrowFooter.addView(highsFooter_row_id);
                        tblrowFooter.addView(highsFooter_invoice_no);
                        tblrowFooter.addView(highsFooter_invoice_date);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(B2BOutstandingCustomerActivity.this);
