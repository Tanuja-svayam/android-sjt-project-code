...
public class Account_Ledger {
    ...
    public Account_Ledger(String sysaccledgerno, String sysaccvoucherno, String voucherdt, String trndesc, String debit, String credit, String refno, String drcr) {
