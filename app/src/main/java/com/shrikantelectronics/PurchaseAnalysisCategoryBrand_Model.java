...
public class PurchaseAnalysisCategoryBrand_Model extends AppCompatActivity {
    ...
    public void invokeWS_DailySales() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/PurchaseAnalysis_Brand_Category_Model", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(PurchaseAnalysisCategoryBrand_Model.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(PurchaseAnalysisCategoryBrand_Model.this);
                                ...
                                tblrowLabels.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(PurchaseAnalysisCategoryBrand_Model.this, SalesAnalysisCategoryBrand_Invoice.class);
...
*/
    ...
    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(PurchaseAnalysisCategoryBrand_Model.this);
