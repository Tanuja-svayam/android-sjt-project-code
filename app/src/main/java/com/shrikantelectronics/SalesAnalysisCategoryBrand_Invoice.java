...
public class SalesAnalysisCategoryBrand_Invoice extends AppCompatActivity {
    ...
    String monthname;
    String locationname, brandname, categoryname, fromdate,todate, sysmodelno;
    ...
    public void invokeWS_DailySales() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/Sales_Daily_Brand_Category_Invoice", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisCategoryBrand_Invoice.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisCategoryBrand_Invoice.this);
                               ...
                               // tblrowLabels.addView(highsLabel_Quantity);
                                ...
                                tblrowLabels.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesAnalysisCategoryBrand_Invoice.this, customer_view_single.class);
    ...
    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(SalesAnalysisCategoryBrand_Invoice.this);
