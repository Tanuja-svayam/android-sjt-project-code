...
public class ListViewAdapter_GeneralCodes_CustomerPriority extends BaseAdapter {
    ...
    public ListViewAdapter_GeneralCodes_CustomerPriority(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("gcname",(GeneralCodeslist.get(position).getgcname()));
                ...
                ((StockVerificationCustomerPriority_view)mContext).setResult(StockVerificationCustomerPriority_view.RESULT_OK,intent);
                ((StockVerificationCustomerPriority_view)mContext).finish();
