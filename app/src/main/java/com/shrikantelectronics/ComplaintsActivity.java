...
public class ComplaintsActivity extends AppCompatActivity {
    ...
    public void invokeWS_FollowupSummary_Pending() {
        ...
        try {
            ...
            header_salesregister.setText("TODAY PENDING COMPLAINTS FOLLOWUPS ");

            ApiHelper.post(URL + "Service1.asmx/Followup_Summary_Pending_Complaints", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(ComplaintsActivity.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(ComplaintsActivity.this);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(ComplaintsActivity.this, CrmActivityComplaints.class);
                        ...
                        TableRow tblrowFooter = new TableRow(ComplaintsActivity.this);
    ...
    public void invokeWS_FollowupSummary_Completed() {
        ...
        try {
            ...
            header_followup_completed.setText("TODAY COMPLETED COMPLAINTS FOLLOWUPS");

            ApiHelper.post(URL + "Service1.asmx/Followup_Summary_Completed_complaints", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(ComplaintsActivity.this);
