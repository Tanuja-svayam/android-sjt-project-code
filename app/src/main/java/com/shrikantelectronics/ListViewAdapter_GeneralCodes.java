...
public class ListViewAdapter_GeneralCodes extends BaseAdapter {
    ...
    public ListViewAdapter_GeneralCodes(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("gcname",(GeneralCodeslist.get(position).getgcname()));
                ...
                ((SvayamGeneralCodes_view)mContext).setResult(SvayamGeneralCodes_view.RESULT_OK,intent);
                ((SvayamGeneralCodes_view)mContext).finish();
