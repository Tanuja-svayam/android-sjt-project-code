...
public class SvayamComplaintDocumentImageActivity extends AppCompatActivity {
    ...
    public String foldername, fileName, remarks, priority, complaint_type ="";
  ...
  //  TextView txtUpdatedOn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   setSupportActionBar(toolbar);
       ...
       // txtUpdatedOn = (TextView) findViewById(R.id.updated_on);
        ...
        complaint_type= i.getStringExtra("complaint_type");
        ...
        builder.setTitle("Permissions required!")
                ...
                .setPositiveButton("GOTO SETTINGS", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        CameraUtils.openSettings(SvayamComplaintDocumentImageActivity.this);
                    }
                })
    ...
    private void launchUploadActivity(boolean isImage){
       // Intent i = new Intent(SvayamComplaintDocumentImageActivity.this, UploadActivity.class);
    ...
    private class UploadFileToServer extends AsyncTask<Void, Void, String> {
        ...
        private String uploadFile() {
            ...
            String SVAYAM_URL_IP = Config.SVAYAM_URL_IP;

            String ATTENDANCE_FILE_UPLOAD_URL = "http://" + SVAYAM_URL_IP + ":4033/Svayam_Complaint_Management/fileUpload.php";
            ...
            try {
                ...
                Request request = new Request.Builder()
                        .url(ATTENDANCE_FILE_UPLOAD_URL)
                        .post(requestBody)
                        .build();
    ...
    public void invokeWS(){
        ...
        paramsMap.put("complaintattachmentfilename",fileName );
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(SvayamComplaintDocumentImageActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(SvayamComplaintDocumentImageActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
