...
public class CrmActivityDemo extends ListActivity {
	// Progress Dialog
			...
			ApiHelper.post(URL + "Service1.asmx/GenerateActivityStatus", paramsMap, new ApiHelper.ApiCallback() {
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_CrmActivityStatus(CrmActivityDemo.this, arraylist);
