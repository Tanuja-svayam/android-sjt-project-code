...
public class Customer_Ledger_View extends AppCompatActivity {
    ...
    public void invokeWS_Customer_Ledger(String custcd){
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetCustomerLedger", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                public void onSuccess(JSONObject response) {
                    ...
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(Customer_Ledger_View.this);
                        ...
                        TextView highsHeading_age = initPlainHeaderTextView();
                        highsHeading_age.setText("Days");
                        highsHeading_age.setTypeface(Typeface.DEFAULT_BOLD);
                        highsHeading_age.setGravity(Gravity.RIGHT);
                        ...
                        tblrowHeading.addView(highsHeading_age);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(Customer_Ledger_View.this);
                                ...
                                TextView highsLabel_age= initPlainTextView(i);
                                highsLabel_age.setText(jsonObject.getString("ageing"));
                                highsLabel_age.setTypeface(Typeface.DEFAULT);
                                highsLabel_age.setGravity(Gravity.CENTER);
                                ...
                                tblrowLabels.addView(highsLabel_age);
                        ...
                        TableRow tblrowFooter = new TableRow(Customer_Ledger_View.this);
                        ...
                        TextView highsFooter_age = initPlainFooterTextView();
                        highsFooter_age.setText(String.valueOf(""));
                        highsFooter_age.setTypeface(Typeface.DEFAULT_BOLD);
                        highsFooter_age.setGravity(Gravity.RIGHT);
                        ...
                        tblrowFooter.addView(highsFooter_age);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(Customer_Ledger_View.this);
            ...
            public void onSuccess(JSONObject response) {
                ...
                try {
                    ...
                    try {
                        ...
                        Utility.downloadAndOpenPdf(Customer_Ledger_View.this, fileUrl,FileName);


                    } catch (ActivityNotFoundException e) {
                        Toast.makeText(Customer_Ledger_View.this, "No Application available to view PDF", Toast.LENGTH_SHORT).show();
                    }
