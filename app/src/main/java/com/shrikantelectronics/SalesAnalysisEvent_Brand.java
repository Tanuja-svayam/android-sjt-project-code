...
public class SalesAnalysisEvent_Brand extends AppCompatActivity {
    ...
    String syseventno, category,  eventdescription;
   ...
   @Override
    ...
    public void navigatetoStockAnalysis_Category(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Brand.this, SalesAnalysisEvent_Category.class);
    ...
    public void navigatetoStockAnalysis_Brand(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Brand.this,SalesAnalysisEvent_Brand.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.putExtra("syseventno",syseventno);
    ...
    public void navigatetoStockAnalysis_Location(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Brand.this,SalesAnalysisEvent_Location.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("eventdescription",eventdescription);
        finish();
    ...
    public void invokeWS_EventSalesAnalysis() {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/SalesAnalysis_Event_Brand", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // myLinearLayout.someTableView.removeAllViews();
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisEvent_Brand.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisEvent_Brand.this);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesAnalysisEvent_Brand.this, SalesAnalysisEvent_Brand_Category.class);
                        ...
                        TableRow tblrowFooter = new TableRow(SalesAnalysisEvent_Brand.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesAnalysisEvent_Brand.this);
