...
public class SalesAnalysisEvent_Brand_Category extends AppCompatActivity {
   ...
   @Override
    ...
    public void invokeWS_EventSalesAnalysis() {
        ...
        try {
            ...
            header_toplocationstock.setText( eventdescription + " " + brandname + " SALES SUMMARY");
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // myLinearLayout.someTableView.removeAllViews();
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisEvent_Brand_Category.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisEvent_Brand_Category.this);
                        ...
                        TableRow tblrowFooter = new TableRow(SalesAnalysisEvent_Brand_Category.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesAnalysisEvent_Brand_Category.this);
