...
public class SalesActivity_Daily_Invoices extends AppCompatActivity {
            ...
            ApiHelper.post(URL + "Service1.asmx/Sales_DailySummary_Orders", paramsMap, new ApiHelper.ApiCallback()   {
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(SalesActivity_Daily_Invoices.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesActivity_Daily_Invoices.this);
                                ...
                                highsLabel_custname.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesActivity_Daily_Invoices.this, customer_view_single.class);
    ...
    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(SalesActivity_Daily_Invoices.this);
