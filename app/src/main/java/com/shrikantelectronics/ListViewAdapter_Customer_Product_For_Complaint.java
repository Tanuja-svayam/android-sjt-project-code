...
public class ListViewAdapter_Customer_Product_For_Complaint extends BaseAdapter {
    ...
    public ListViewAdapter_Customer_Product_For_Complaint(Context context,
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(mContext, CreateCustomerComplaint.class);

                intent.putExtra("sysorderdtlno",(customerdetails.get(position).getsysorderdtlno()));
                intent.putExtra("invoiceno",(customerdetails.get(position).getinvoiceno()));
                intent.putExtra("invoicedt",(customerdetails.get(position).getinvoicedt()));
                intent.putExtra("brandname",(customerdetails.get(position).getbrandname()));
                intent.putExtra("modelname",(customerdetails.get(position).getmodelname()));
                intent.putExtra("topcategoryname",(customerdetails.get(position).gettopcategoryname()));
                intent.putExtra("parentcategoryname",(customerdetails.get(position).getparentcategoryname()));
                intent.putExtra("categoryname",(customerdetails.get(position).getcategoryname()));
                intent.putExtra("serialno",(customerdetails.get(position).getserialno()));
                intent.putExtra("netamt",(customerdetails.get(position).getnetamt()));
                intent.putExtra("manufacturer_warranty_tenure",(customerdetails.get(position).getmanufacturer_warranty_tenure()));
                intent.putExtra("warranty_start_date",(customerdetails.get(position).getwarranty_start_date()));
                intent.putExtra("warranty_end_date",(customerdetails.get(position).getwarranty_end_date()));
                intent.putExtra("sysproductcategoryno_top",(customerdetails.get(position).getsysproductcategoryno_top()));
                intent.putExtra("sysbrandno",(customerdetails.get(position).getsysbrandno()));
                intent.putExtra("sysmodelno",(customerdetails.get(position).getsysmodelno()));

                ((CustomerComplaint_Product_Activity)mContext).setResult(CustomerComplaint_Product_Activity.RESULT_OK,intent);
                ((CustomerComplaint_Product_Activity)mContext).finish();
