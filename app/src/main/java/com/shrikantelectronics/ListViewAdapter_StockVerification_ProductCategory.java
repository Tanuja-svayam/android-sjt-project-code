...
public class ListViewAdapter_StockVerification_ProductCategory extends BaseAdapter {
    ...
    public ListViewAdapter_StockVerification_ProductCategory(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("description",(ProductCategorylist.get(position).getdescription()));
                ...
                ((StockVerificationProductCategory_view)mContext).setResult(StockVerificationProductCategory_view.RESULT_OK,intent);
                ((StockVerificationProductCategory_view)mContext).finish();
