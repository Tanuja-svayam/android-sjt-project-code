...
public class SalesAnalysisEvent_Category extends AppCompatActivity {
    ...
    String syseventno, brandname, eventdescription;
   ...
   @Override
    ...
    public void navigatetoStockAnalysis_Category(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Category.this, SalesAnalysisEvent_Category.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("brandname","");
    ...
    public void navigatetoStockAnalysis_Brand(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Category.this,SalesAnalysisEvent_Brand.class);

        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("category","");
        homeIntent.putExtra("eventdescription",eventdescription);
        finish();
        startActivity(homeIntent);
    }
    ...
    public void navigatetoStockAnalysis_Location(){
        Intent homeIntent = new Intent(SalesAnalysisEvent_Category.this,SalesAnalysisEvent_Location.class);
        homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        homeIntent.putExtra("syseventno",syseventno);
        homeIntent.putExtra("eventdescription",eventdescription);
        finish();
    ...
    public void invokeWS_EventSalesAnalysis() {
        ...
        try {
            ...
            header_toplocationstock.setText(  eventdescription  + " SALES SUMMARY");

            ApiHelper.post(URL + "Service1.asmx/SalesAnalysis_Event_Category", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                       ...
                       // myLinearLayout.someTableView.removeAllViews();
                        ...
                        TableRow tblrowHeading = new TableRow(SalesAnalysisEvent_Category.this);
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(SalesAnalysisEvent_Category.this);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(SalesAnalysisEvent_Category.this, SalesAnalysisEvent_Category_Brand.class);
                                        intent.putExtra("syseventno",syseventno);
                                        intent.putExtra("category",highsLabel_category.getText());
                        ...
                        TableRow tblrowFooter = new TableRow(SalesAnalysisEvent_Category.this);
    ...
    private TextView initPlainTextView(float n) {
        ...
        TextView textView = new TextView(SalesAnalysisEvent_Category.this);
