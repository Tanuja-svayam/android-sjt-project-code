...
public class Ledger_finance extends AppCompatActivity {
    ...
    public void invokeWS_FinanceList() {
        ...
        try {
            ...
            header_salesregister.setText("FINANCE");

            ApiHelper.post(URL + "Service1.asmx/Finance_List", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(Ledger_finance.this);
                       ...
                       //tblrowHeading.addView(highsheading_Value);
                        ...
                        JSONArray new_array = obj.getJSONArray("financecompanylist");
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(Ledger_finance.this);
                               ...
                               final TextView highsLabel_category = initPlainTextView(i);
                                ...
                                highsLabel_category.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(Ledger_finance.this, Ledger_Finance_View.class);
                        ...
                        TableRow tblrowFooter = new TableRow(Ledger_finance.this);
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(Ledger_finance.this);
