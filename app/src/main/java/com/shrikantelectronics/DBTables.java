...
public class DBTables {
    ...
    public static final String EVENT_EMPLOYEE_ID = "sysemployeeno";
    public static final String EVENT_SOURCETABLEPK = "sourcetablepk";
    public static final String EVENT_SOURCETABLE = "sourcetable";

    // Recurring Pattern Table l'
