...
public class ListViewAdapter_GeneralCodes_CustomerType extends BaseAdapter {
    ...
    public ListViewAdapter_GeneralCodes_CustomerType(Context context,
        ...
        view.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
               ...
               intent.putExtra("gcname",(GeneralCodeslist.get(position).getgcname()));
                ...
                ((StockVerificationCustomerType_view)mContext).setResult(StockVerificationCustomerType_view.RESULT_OK,intent);
                ((StockVerificationCustomerType_view)mContext).finish();
