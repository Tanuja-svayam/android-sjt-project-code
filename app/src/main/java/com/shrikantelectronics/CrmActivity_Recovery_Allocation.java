...
public class CrmActivity_Recovery_Allocation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crmrecoveryallocation);
    ...
    public void invokeWS_Followuplist(String locationname, String activitytypedesc) {
        ...
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/CRM_Activity_Followup_Recovery_Allocation_Pending", paramsMap, new ApiHelper.ApiCallback()   {
                @Override
                ...
                public void onSuccess(JSONObject response) {
                    try {
                        ...
                        TableRow tblrowHeading = new TableRow(CrmActivity_Recovery_Allocation.this);
                        ...
                        highsHeading_Quantity.setText("Invoice");
                        ...
                        highsheading_productvalue.setText("Outstanding");
                        ...
                        for (int i = 0, count = new_array.length(); i < count; i++) {
                            try {
                                ...
                                TableRow tblrowLabels = new TableRow(CrmActivity_Recovery_Allocation.this);
                                ...
                                highsLabel_custname.setOnClickListener(new View.OnClickListener()
                                {
                                    ...
                                    {
                                        Intent intent = new Intent(CrmActivity_Recovery_Allocation.this, CrmActivity_Recovery_Allocation_Single.class);
                                ...
                                highsLabel_Quantity.setText(jsonObject.getString("invoiceno"));
                                ...
                                highslabel_productvalue.setText(jsonObject.getString("charges"));
	    ...
	    private TextView initPlainTextView(float n) {
	        ...
	        TextView textView = new TextView(CrmActivity_Recovery_Allocation.this);
