...
public class StockVerificationFinance_view extends Activity {
    ...
    public void invokeWS_Financecompany(){
        try {
            ...
            ApiHelper.post(URL + "Service1.asmx/GetFinanceList", paramsMap, new ApiHelper.ApiCallback()   {
            @Override
            ...
            public void onSuccess(JSONObject response) {
                try {
                    ...
                    adapter = new ListViewAdapter_StockVerification_FinanceCompany(StockVerificationFinance_view.this, arraylist);
