...
public class SalesSummery_Brand extends ListActivity {
	// Progress Dialog
	...
	public void invokeWS_Product(Map<String, String> paramsMap){
		try {
			...
			ApiHelper.post(URL + "Service1.asmx/GetBranchSalesDetails_Brand", paramsMap, new ApiHelper.ApiCallback()   {
				@Override
				...
				public void onSuccess(JSONObject response) {
					try {
						...
						adapter = new ListViewAdapter_Dashboard_Sales(SalesSummery_Brand.this, arraylist);
